...
public class MyServletFilter2 implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        LOG.info(">>####>> MyServletFilter2#init(), ac check : {}, ms check : {}", appname, msg);
    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        String msg = messageSource.getMessage("msg.sample1", null, Locale.getDefault());
        String appname = applicationContext.getApplicationName();
        LOG.info(">>####>> MyServletFilter2#doFilter(), ac check : {}, ms check : {}", appname, msg);
    ...
    public void destroy() {
        String msg = messageSource.getMessage("msg.sample1", null, Locale.getDefault());
        String appname = applicationContext.getApplicationName();
        LOG.info(">>####>> MyServletFilter2#destroy(), ac check : {}, ms check : {}", appname, msg);
    }
